# ghithub_trends_digger

The 'ghithub_trends_digger' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] ghithub_trends_digger_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/ghithub_trends_digger.job.yml). The schedule
